...
const Profile = () => {
    ...
    const fetchUserData = async () => {
        try {
            ...
            const response = await fetch(`http://192.168.1.22:5137/api/UserDetails/GetUserDetails/${numericID}`);
            if (!response.ok) {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const response = await fetch(`http://192.168.1.22:5137/api/UserDetails/UpdateUserDetails/${numericID}`, {
                method: 'PUT',
                headers: {
                ...
                <View style={styles.userInfoContainer}>
                    ...
                    {additionalUserData && (
                        <>
                            ...
                            <View style={styles.row}>
                                <Text style={styles.label}>Insulin Details:</Text>
                                {isEditing ? (
                                    <TextInput
                                        style={styles.editableInfo}
